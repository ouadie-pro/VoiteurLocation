            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow rounded-4 overflow-hidden h-100">
                    <div class="position-relative">
                        <img src="../img_voiteur/car sport/car sport (2).jpg" alt="voiteur umage" class="card-img-top img-fluid" style="height: 300px;object-fit: cover;">
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row text-center g-0">
                                ...
                                <div class="col-4">
                                    <div class="p-2 border-start border-end">
                                        ...
                                        <p class="mb-0 small fw-bold">12,7 L/100 km</p>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-auto">
                                <p class="mb-0 fw-bolder fs-5">€250<span class="text-muted fs-6">/day</span></p>
                            </div>
