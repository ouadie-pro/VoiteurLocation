...
<body>
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card product-card h-100">
                    <img src="../img_voiteur/car classic/car classic (2).jpg" class="card-img-top img-fluid">
                    <div class="card-body d-flex flex-column">
                        <h1 class="card-title" style="text-transform: capitalize;">cadillac series 62 (1949)</h1>
                        <p style="text-transform: capitalize;">classic-car</p>
                        <div style="border-top: 1px solid gray;"></div>
                        <div style="display: flex;flex-direction: row;justify-content: space-between;margin-top: 20px">
                            <h2></h2>
